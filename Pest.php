...
<?php
// ดึงข้อมูลจาก API
$apiUrl = "http://localhost:8080/csP1015/project/api_p.php?page=" . ($_GET['page'] ?? 1);
     ...
     <div class="nav-container">
          <nav class="navbar">
               ...
               <ul class="nav-links">
                    ...
                    <li><a href="#">ข้อมูลแมลงศัตรูพืช</a></li>
     ...
     <section class="wave-section">
          <div class="wave-container">
               <div class="wave-header">
                    <h2>ข้อมูลศัตรูพืช</h2>
               </div>
               <div class="row">
                    <?php foreach ($pests as $index => $row): ?>
                         <div class="col-md-4 mb-4"> <!-- Bootstrap col-md-4 creates 3 columns in a row -->
                              <div class="feature-card" data-bs-toggle="modal" data-bs-target="#modal-<?php echo $index; ?>">
                                   <?php
                                   $pest_id = str_pad($row['id'] ?? 0, 5, '0', STR_PAD_LEFT);
                                   $imagePath = htmlspecialchars($row['image']);
                                   // เพิ่มพารามิเตอร์เวลาเพื่อป้องกันการแคช
                                   $imagePath .= (strpos($imagePath, '?') === false ? '?' : '&') . "v=" . time();
                                   ?>
                                   <img src="<?php echo $imagePath; ?>"
                                        alt="<?php echo htmlspecialchars($row['name_th']); ?>" class="img-thumbnail"
                                        style="width:250px; height: 220px;">
                                   <div class="feature-content">
                                        <h3><?php echo htmlspecialchars($row['name_th']); ?></h3>
                                        <p><?php echo htmlspecialchars($row['name_en']); ?></p>
                                   </div>
                              </div>
                                   ...
                                   <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                             ...
                                             <div class="modal-body text-center">
                                                  <img src="<?php echo $imagePath; ?>"
                                                       alt="<?php echo htmlspecialchars($row['name_th']); ?>"
                                                  ...
                                                  <p class="text-start"><b>ชื่อวิทยาศาสตร์:</b>
                                                       <?php echo htmlspecialchars($row['name_sci']); ?>
                                                  </p>

                                                  <label for="appearance" class="form-label text-start d-block">
                                                       <b>ลักษณะ</b>
                                                  </label>
                                                  <textarea class="form-control border-0 shadow-none text-start p-0"
                                                       name="appearance" rows="4" readonly><?php echo htmlspecialchars($row['appearance']); ?>
                                                                      </textarea>

                                                  <label for="prevention" class="form-label text-start d-block">
                                                       <b>การป้องกัน</b>
                                                  </label>
                                                  <textarea class="form-control border-0 shadow-none text-start p-0"
                                                       name="prevention" rows="4" readonly><?php echo htmlspecialchars($row['prevention']); ?>
                                                                      </textarea>

                                                  <label for="details" class="form-label text-start d-block">
                                                       <b>รายละเอียด</b>
                                                  </label>
                                                  <textarea class="form-control border-0 shadow-none text-start p-0"
                                                       name="details" rows="4" readonly><?php echo htmlspecialchars($row['details']); ?>
                                                                      </textarea>
                                             </div>

                         ...
                         <div class="main-content p-4">
                              <form id="vegForm" action="http://localhost:8080/csP1015/project/vegetable/api.php"
                                   ...
                                   <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="sci_name" required>
                                   </div>
                                   <div class="mb-3">
                                        <label for="growth" class="form-label">ระยะเวลาปลูกจนเก็บเกี่ยว</label>
                                        <input type="number" class="form-control" name="growth" required>
                                   </div>
                                   <div class="mb-3">
                                        <label for="planting_method" class="form-label">วิธีปลูก</label>
                                        <textarea class="form-control" name="planting_method" rows="4"></textarea>
                                   </div>
                                   <div class="mb-3">
                                        <label for="care" class="form-label">การดูแล</label>
                                        <textarea class="form-control" name="care" rows="4" required></textarea>
                                   </div>
                                   <div class="mb-3">

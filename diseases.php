...
<?php
// ดึงข้อมูลจาก API
$apiUrl = "http://localhost:8080/csP1015/project/api_d.php?page=" . ($_GET['page'] ?? 1);
...
<body>
     ...
     <section class="wave-section">
          <div class="wave-container">
               ...
               <div class="row">
                    <?php foreach ($diseases as $index => $row): ?>
                         <div class="col-md-4 mb-4"> <!-- Bootstrap col-md-4 creates 3 columns in a row -->
                              <div class="feature-card" data-bs-toggle="modal" data-bs-target="#modal-<?php echo $index; ?>">
                                   ...
                                   <img src="<?php echo $imagePath; ?>"
                                        alt="<?php echo htmlspecialchars($row['disease_name_th']); ?>" class="img-thumbnail"
                                        style="width:250px; height: 220px;">
                                   <div class="feature-content">
                                        <h3><?php echo $row['disease_name_th']; ?></h3>
                                        <p><?php echo htmlspecialchars($row['disease_name_en']); ?></p>
                                   </div>
                              </div>
                                   ...
                                   <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                             ...
                                             <div class="modal-body text-center">
                                                  <img src="<?php echo $imagePath; ?>"
                                                       alt="<?php echo $row['disease_name_th']; ?>" class="img-fluid mb-3"
                                                       style="width: 550px;">
                                                  <p class="text-start"><b>ชื่อภาษาไทย :</b>
                                                       <?php echo $row['disease_name_th']; ?>
                                                  </p>
                                                  <p class="text-start"><b>ชื่อภาษาอังกฤษ :</b>
                                                       <?php echo htmlspecialchars($row['disease_name_en']); ?>
                                                  </p>
                                                  <label for="cause"
                                                       class="form-label text-start d-block"><b>สาเหตุของโรค</b></label>
                                                  <textarea class="form-control border-0 shadow-none text-start p-0"
                                                       name="cause" rows="4" required><?php echo htmlspecialchars($row['cause']); ?>
                                                                                                         </textarea>
                                                  <label for="symptoms"
                                                       class="form-label text-start d-block"><b>อาการของโรค</b></label>
                                                  <textarea class="form-control border-0 shadow-none text-start p-0"
                                                       name="care" rows="5" required><?php echo htmlspecialchars($row['symptoms']); ?>
                                                                                                         </textarea>
                                                  <label for="planting_method"
                                                       class="form-label text-start d-block"><b>วิธีการรักษา</b></label>
                                                  <textarea class="form-control border-0 shadow-none text-start p-0"
                                                       name="treatment" rows="4" required><?php echo htmlspecialchars($row['treatment']); ?>
                                                                                                         </textarea>
                                                  <label for="planting_method"
                                                       class="form-label text-start d-block"><b>การป้องกัน</b></label>
                                                  <textarea class="form-control border-0 shadow-none text-start p-0"
                                                       name="prevention" rows="4" required><?php echo htmlspecialchars($row['prevention']); ?>
                                                                                 </textarea>
                                             </div>

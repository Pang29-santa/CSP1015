<?php
// Update API URL to pests endpoint
$apiUrl = "http://localhost:8080/csP1015/project/pests/api.php?page=" . ($_GET['page'] ?? 1);
     ...
     <div class="container-fluid">
          <div class="row">
               ...
               <div class="col-md-10 p-4">
                    <div class="row mb-4 align-items-center">
                         <div class="col">
                              <h1 class="mb-3">ข้อมูลแมลงศัตรูพืช</h1>
                         </div>
                         <div class="col-auto">
                              <div class="dropdown">
                    ...
                    <div class="table-wrapper">
                         ...
                         <table class="table table-bordered" id="pestsTable">
                              <thead>
                                   <tr>
                                        <th>No.</th>
                                        <th>ชื่อศัตรูพืช (ภาษาไทย)</th>
                                        <th>ชื่อศัตรูพืช (ภาษาอังกฤษ)</th>
                                        <th>รูปตัวอย่างศัตรูพืช</th>
                                        <th>จัดการ</th>
                                   </tr>
                              </thead>
                              <tbody>
                                        ...
                                        <tr>
                                             ...
                                             <td>
                                                  <img src="<?php echo $row['image']; ?>"
                                                       alt="<?php echo $row['thai_name']; ?>" width="500">
                                             </td>
                                             <td>
                                                  <a href="PE1_detail.php?id=<?php echo $row['id']; ?>"
                                                       class="btn btn-info btn-sm">
                                                       <i class="bi bi-file-text"></i>
                                                  </a>
                                                  <a href="PE1_edit.php?id=<?php echo $row['id']; ?>"
                                                       class="btn btn-warning btn-sm">
                                                       <i class="bi bi-pencil"></i>
                                                  </a>
                                                  <button class="btn btn-danger btn-sm" onclick="deletePest(this)"
          ...
          <script>
               function deletePest(button) {
                    const pestId = button.getAttribute("data-id"); // รับค่า ID จากปุ่มที่กด
                    ...
                    if (!confirm(`คุณแน่ใจหรือไม่ว่าต้องการลบ ID ${pestId} ?`)) {
                         return; // ยกเลิกการลบถ้าผู้ใช้กดยกเลิก
                    }

                    fetch("http://localhost:8080/csP1015/project/pests/api.php", {
                         method: "DELETE",
                         headers: {
                              "Content-Type": "application/json"
                         },
                         body: JSON.stringify({ id: pestId }) // ส่งค่า ID ไปยัง API
                    })

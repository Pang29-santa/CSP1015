                         ...
                         <div class="main-content p-4">
                              <form id="pestForm" action="http://localhost:8080/csP1015/project/pests/api.php"
                                   ...
                                   <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name_sci" required>
                                   </div>
                                   <div class="mb-3">
                                        <label for="appearance" class="form-label">ลักษณะ</label>
                                        <textarea class="form-control" name="appearance" rows="4" required></textarea>
                                   </div>
                                   <div class="mb-3">
                                        <label for="prevention" class="form-label">การป้องกัน</label>
                                        <textarea class="form-control" name="prevention" rows="4" required></textarea>
                                   </div>
                                   <div class="mb-3">

               ...
               <div class="col-md-10 p-4">
                    ...
                    <div class="table-wrapper">
                         <div class="main-content p-4">
                              <form id="pestForm" action="http://localhost:8080/csP1015/project/pests/api.php"
                                   ...
                                   <div class="mb-3">
                                        <label for="name_sci" class="form-label">ชื่อวิทยาศาสตร์</label>
                                        <input type="text" class="form-control" name="name_sci"
                                             value="<?php echo htmlspecialchars($data['sci_name']); ?>" required>
                                   </div>
                                   <div class="mb-3">
                                        <label for="appearance" class="form-label">ลักษณะ</label>
                                        <textarea class="form-control" name="appearance" rows="4"
                                             required><?php echo htmlspecialchars($data['appearance']); ?></textarea>
                                   </div>
                                   <div class="mb-3">
                                   ...
                                   <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control mb-3" id="image" name="image"
                                             accept="image/*">
                                        <img src="../img/P/<?php echo str_pad($data['id'], 5, '0', STR_PAD_LEFT); ?>_1.jpg?t=<?php echo time(); ?>"

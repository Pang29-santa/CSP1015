                    ...
                    <div class="table-wrapper">
                         <div class="main-content p-4">
                              <div class="mb-3">
                                   ...
                                   <input type="text" class="form-control" name="disease_name_th" id="disease_name_th"
